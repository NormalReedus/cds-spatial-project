...
# ÆNDR TIL BARE AT VÆRE EN HARDCODET VÆRDI FRA VORES MÅLING, OG SÅ SÆT res(aarhus_NDVI) TIL AT VÆRE VÆRDIEN
...
```
ÆNDR (~360) TIL DEN NYE STØRRELSE AF LIGE OVER 10 PIX
...
area_min_size <- 360 # EDIT THIS TO THE NEW RES OF JUST ABOVE 10 PIX
