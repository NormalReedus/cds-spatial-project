...
We will need to define a fitting NDVI threshold for our definition of a 'green area' so not every field and bush is displayed alongside parks and forests. To do this, we found inspiration [here](linktoarticle.com)
...
About 16% of the total area of our (imprecisely) defined Aarhus area is covered in what we have chosen to define as 'green areas'.
